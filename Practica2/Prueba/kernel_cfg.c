/*
 *  kernel_cfg.c
 *  Fri Dec 27 19:49:20 2013
 *  SG Version 2.00
 *  sg ./Practica_1c.oil -os=ECC2 -I/home/jmherruzo/LEGO/nxtOSEK/ecrobot/../toppers_osek/sg/impl_oil -template=/home/jmherruzo/LEGO/nxtOSEK/ecrobot/../toppers_osek/sg/lego_nxt.sgt
 */
...
const TaskType Derecha = 1;
const TaskType Izquierda = 2;
const TaskType Correccion = 3;

extern void TASKNAME( Avance )( void );
extern void TASKNAME( Derecha )( void );
extern void TASKNAME( Izquierda )( void );
extern void TASKNAME( Correccion )( void );

static __STK_UNIT _stack_Avance[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_Derecha[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_Izquierda[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_Correccion[__TCOUNT_STK_UNIT(512)];

const Priority tinib_inipri[TNUM_TASK] = { TPRI_MINTASK + 1, TPRI_MINTASK + 3, TPRI_MINTASK + 3, TPRI_MINTASK + 2, };
const Priority tinib_exepri[TNUM_TASK] = { TPRI_MINTASK + 1, TPRI_MINTASK + 3, TPRI_MINTASK + 3, TPRI_MINTASK + 2, };
const UINT8 tinib_maxact[TNUM_TASK] = { (1) - 1, (1) - 1, (1) - 1, (1) - 1, };
const AppModeType tinib_autoact[TNUM_TASK] = { 0x00000001, 0x00000000, 0x00000000, 0x00000000, };
const FP tinib_task[TNUM_TASK] = { TASKNAME( Avance ), TASKNAME( Derecha ), TASKNAME( Izquierda ), TASKNAME( Correccion ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_Avance, (__STK_UNIT)_stack_Derecha, (__STK_UNIT)_stack_Izquierda, (__STK_UNIT)_stack_Correccion, };
...
const TickType alminib_almval[TNUM_ALARM] = { 10, };
...
const EventMaskType Giro = (1UL << 0);
